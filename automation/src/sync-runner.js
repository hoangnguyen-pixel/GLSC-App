...
async function runScript(script) {
  ...
  // selbst über index.html eingetragenen Zugangsdaten aus Secret Manager
  // VOR dem Start des Kindprozesses in dessen env einsetzen. Muss hier und
  // nicht im jeweiligen Skript selbst passieren, da die Skripte ihre
  // Zugangsdaten als Konstanten beim eigenen require() lesen — für den
  // lokalen Betrieb (kein K_SERVICE, z.B. Ost/West) bleibt env unverändert.
